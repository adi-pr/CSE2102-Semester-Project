...
class AddDriverTab:
    ...
    def __init__(self, tab_control, controller):
        ...
        tab_control.add(self.tab, text="Add Driver")
        ...
        button_commit = ttk.Button(self.tab, text="Add Driver", command=self.add_driver)
        button_commit.grid(
    ...
    def add_driver(self):
        ...
        self.controller.write_driver_to_database(form_data)
