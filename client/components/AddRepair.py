...
class AddRepairTab:
    ...
    def __init__(self, tab_control, controller):
        ...
        tab_control.add(self.tab, text="Add Repair")
        ...
        button_commit = ttk.Button(self.tab, text="Add Repair", command=self.add_repair)
        button_commit.grid(
    ...
    def add_repair(self):
        ...
        self.controller.write_repair_to_database(form_data)
